<?php
                  ...
                  <div style="display:flex;margin-top:-3.5vw">
                       <fieldset class="fieldset_1">
                          ...
                          <div  style="display:flex">
                               ...
                               <div id="debit_card_details" style="margin-top:-6.5vw">
                               <form method="POST" action="">
                               <table class="payment_card_details" >
                               <tr>
                                   <td colspan="2">
                                      <div class="group">      
                                          <input type="text" name="Total_seats" id="cardnumber" class="input" required >
                                          <label>Total seats</label>
                                      </div>
                                   </td>   
                                   <td colspan="2">
                                      <div class="group">      
                                          <input type="date" name="date_seat" id="cardnumber" class="input" required style="width:10vw">
                                      </div>
                                   </td>                                         
                               </tr>
                               </table>
                                  
                                    <table class="debit_card_details_table" style="margin-top:-5.5vw">
                                        <tr>
                                    ...
                                    <form method="POST" action="">
                                    <table class="payment_card_details" style="margin-top:-6.5vw" >
                                    <tr>
                                        <td colspan="2">
                                           <div class="group">      
                                               <input type="text" name="Total_seats" id="cardnumber" class="input" required >
 ...
 if(isset($_POST['button1'])){
  ...
  $final_order="INSERT INTO `customer_orders`(`Payment_id`, `customer_email`, `Total_items`, `Dish_names`, `total_seats`, `Hotel_name`, `Date/time`, `total_amount_paid`, `payment_details`,`Date`) 
                                      VALUES ('$Payment','$user_email_id','$total_rows','$Dish_name','   $Total_seats','$hotel_name_cart','$date_seat','$total_payment','Card Number : $card_details Name on card : $name_on_card Time : $date_time','$date')";
 ...
 if(isset($_POST['button2'])){
  ...
  if(mysqli_query($con,$sql)){
      ...
      $final_order="INSERT INTO `customer_orders`(`Payment_id`, `customer_email`, `Total_items`, `Dish_names`, `total_seats`, `Hotel_name`, `Date/time`, `total_amount_paid`, `payment_details`,`Date`) 
                                          VALUES ('$Payment','$user_email_id','$total_rows','$Dish_name',' $Total_seats','$hotel_name_cart','$date_seat','$total_payment','UPI ID : $UPL_id Time : $date_time','$date')";
                                         if( mysqli_query($con,$final_order)){
                                               $delete_all_cart="DELETE FROM `customer_cart` WHERE `customer_email` = '$user_email_id'";
                                               if(mysqli_query($con,$delete_all_cart)){
                                                  echo  '<script type="text/javascript" language="javascript">
