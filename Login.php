    ...
    <fieldset id="Middle_fieldset">
        ...
        <form method="post" name="user_login_page">
            ...
            <!--Row-1-->
                ...
                <tr>
                   <td id="final_button"><a href = "Registration_page.php" target = "_parent"><input  type = "button"  value = "Sign Up" id="back"></button></a>
      ...
      if ($getuserdata->num_rows > 0) {
        ...
        if($getemail_ID==$email_id && $getpassword!=$password){
          ...
          if($getemail_ID==$email_id && $getpassword==$password)
          {
              ...
              echo'
                 <script>           
                    location.href="http://localhost/Project_yummy/Home_page.php";
                 </script>
              ';
